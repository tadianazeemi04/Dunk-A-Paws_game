...
@class UIColor;
@class NSCoder;
SWIFT_CLASS("_TtC4Game10AnimalNode")
@interface AnimalNode : SKSpriteNode
...
SWIFT_CLASS("_TtC4Game7FanNode")
@interface FanNode : SKNode
...
SWIFT_CLASS("_TtC4Game8HoopNode")
@interface HoopNode : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC4Game12IceBlockNode")
@interface IceBlockNode : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC4Game13SlingshotNode")
@interface SlingshotNode : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC4Game8StarNode")
@interface StarNode : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC4Game14TrampolineNode")
@interface TrampolineNode : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
